...
/*-----------IMPORT MUI & CSS-----------*/
import { Stack, Collapse, Box , Drawer, Button , Divider ,  IconButton, Avatar, Typography, List, ListItem} from "@mui/material";
      ...
      return (
        <div>
            ...
            <React.Fragment key={'left'}>
              <IconButton onClick={toggleDrawer('left', true)} color="primary" aria-label="add to shopping cart">
