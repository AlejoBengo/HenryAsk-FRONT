          ...
          <CardActionArea>
            ...
            >
              ...
              <Grid item xs={6}>
                ...
                >
                  Un programa intensivo en línea que simula un entorno de
                  trabajo real y te prepara para una carrera exitosa como
          ...
          <CardActionArea>
            ...
            >
              <Grid item xs={6}>
                ...
                >
                  En Henry invertimos en tu educación. Ahora puedes convertirte
                  en Full Stack Web Developer mientras trabajas. Diseñamos una
                  carrera part-time de 7 meses para que ingreses al mercado
                  tech.
                </Typography>
              </Grid>
              <Grid item xs={4}>
            ...
            <CardActions sx={{ height: "40%", justifyContent: "center" }}>
              <Link
                href="https://www.soyhenry.com/carrera-part-time-desarrollo-full-stack"
                color="inherit"
                underline="none"
                target="_blank"
              >
