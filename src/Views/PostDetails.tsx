...
import {InputLabel  , FormControl , Select , SelectChangeEvent , Grid} from "@mui/material"
          ...
          <Box sx={{display:"flex" , justifyContent:"space-between"}}>
            <Typography
              ...
              sx={{
                ...
                textDecorationColor: "primary.main", width:"90%"
              }}
              align="left"
              gutterBottom
            >
            ...
            <Box>
              <IconButton onClick={(ev)=>handleOpenModalReport('post')} aria-label="delete" size="large" color="error">
      ...
      {/* MODAL DIALOG REPORT END */}    
          ...
          >
            <Typography
              ...
              alignItems={"center"}
            >
              <UserShort user={postOwner} /><EventAvailableIcon fontSize="medium" sx={{marginX:"8px", marginBottom:"3px"}} />Preguntado el {post.createdAt}  {/* arreglar el horario */}
            </Typography>
            <Typography variant="caption" sx={{ marginRight: "5px" , display:"flex" , alignItems:"center" }}>
              <LocalOfferIcon sx={{margin:"0px 15px 0px 0px"}}/> {post.tags.join(", ")}
            </Typography>
          </Box>
