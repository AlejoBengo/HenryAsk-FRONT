                  ...
                  >
                    ...
                    <Grid item xs={6}>
                      ...
                      >
                        ...
                        campo del hacking ético, con un interés enfocado hacia
                        el desarrollo de Back-end . Poseo una gran capacidad en
                        el ámbito social, con predisposición al trabajo en
                        grupo, proactivo y de fácil adaptabilidad.
                      </Typography>
                    </Grid>
                  </Grid>
                </Link>
                  ...
                  >
                    ...
                    <Grid item xs={6}>
                      ...
                      >
                        ...
                        entorno laboral real y lograr una progresiva mejora de
                        mis habilidades, tanto con las tecnologías que ya
                        conozco como las nuevas🙌
                      </Typography>
                    </Grid>
                  </Grid>
                </Link>
                  ...
                  >
                    ...
                    <Grid item xs={6}>
                      ...
                      >
                        ...
                        autodidacta. También manejo los lenguajes de
                        programación C++, Javascript, Python y PHP.
                      </Typography>
                    </Grid>
                  </Grid>
                </Link>
                  ...
                  >
                    ...
                    <Grid item xs={6}>
                      ...
                      >
                        ...
                        encuentro realizando proyectos propios a modo de
                        práctica con el fin de aplicar lo que voy aprendiendo en
                        el camino y pulir los conocimientos adquiridos
                      </Typography>
                    </Grid>
                  </Grid>
                </Link>
                  ...
                  >
                    ...
                    <Grid item xs={6}>
                      ...
                      >
                        ...
                        ocupar roles de acción, guía y acompañamiento, con un
                        estilo consciente, ético, cálido y personalizado. Además
                        de esto, desarrolle mucho mis habilidades de gestión
                        emocional, lo que me permite superar situaciones y
                        ritmos desafiantes en lo laboral.
                      </Typography>
                    </Grid>
                  </Grid>
                </Link>
